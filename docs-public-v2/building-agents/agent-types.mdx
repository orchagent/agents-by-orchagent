...
| **Service deploy** | No | Yes | Yes | No |

<Tip>
**Tool** and **agent** type agents can be deployed as [always-on services](/using-agents/services) for long-running workloads like Discord bots, webhook listeners, and background workers.
</Tip>
