...
New publishes with dependencies default to strict mode. In strict mode:
...
Opt in to flexible mode when your orchestrator needs the freedom to solve some tasks directly:
...
If strict was applied by default and you didn't intend it, republish with `orchestration_mode: "flexible"` in your manifest.
