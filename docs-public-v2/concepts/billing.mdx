...
Set spending limits on workspaces or individual agents to prevent unexpected costs. Budget policies support daily, weekly, or monthly windows with configurable actions — alert-only, block new runs, or pause services.

See the full [Budgets](/using-agents/budgets) documentation for setup and configuration.
