...
Code agents have separate limits for compute time (sandbox execution):
...
<Note>
Code agent limits are **separate** from prompt agent limits. You can use both types with their respective quotas.
</Note>
