...
<Tip>
**Want to skip the setup?** Use `orch init my-orchestrator --template fan-out` to scaffold a complete parallel orchestrator instantly. Templates are also available for `pipeline` (sequential) and `map-reduce` patterns. See [Building an Orchestrator](/building-agents/building-orchestrators#quick-start-with-templates) for details.
</Tip>
...
|---------|--------------|
| `callable` | Whether other agents can call this agent (default: `true`) |
