...
<CardGroup cols={2}>
  ...
  <Card title="Build" icon="hammer" href="/building-agents/agent-types">
    Create an agent or skill (prompt, agentic, or code)
  </Card>
