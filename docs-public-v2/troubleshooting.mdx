...
**Fix:**
1. Check the schema: `orch info acme/agent`
...
**Fix:** The target agent needs to be republished with callable enabled:

```bash
# In the target agent's orchagent.json
{ "callable": true }
```
