...
| Target | Behavior |
|--------|----------|
| *(none)* or agent name | Lists recent runs in a table. If filtering by agent name and an always-on service exists, service logs are shown below the runs table. |
