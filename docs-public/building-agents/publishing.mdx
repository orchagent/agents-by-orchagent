---
title: "Publishing"
description: "How to publish your agent to OrchAgent"
---

# Publishing

Publish your agent to make it available on the platform.

## Prerequisites

1. OrchAgent account with API key
2. CLI installed and authenticated
3. `orchagent.json` manifest in your agent directory
